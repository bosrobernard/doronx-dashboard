  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'payment-stands',
        loadChildren: () =>
          import('./payment-stands/payment-stands.module').then(
            (m) => m.PaymentStandsModule,
          ),
      },
      {
        path: 'wallets',
      ...
      },
      {
        path: 'webhooks',
        loadChildren: () =>
          import('./webhook-management/webhook-management.module').then(
            (m) => m.WebhookManagementModule,
          ),
      },
      {
        path: 'reports',
